(() => {
  'use strict';
  const polish=document.createElement('link');polish.rel='stylesheet';polish.href='raven-chat-polish.css?v=20260915-2';document.head.append(polish);
